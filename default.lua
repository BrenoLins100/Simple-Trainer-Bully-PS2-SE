...
main = function()
  ...
  TextPrintString("Press".."~LOOK_BACK~".. "+".. "~dleft~",10,2)
  ...
  repeat
    ...
    if IsButtonBeingPressed(0,0) and IsButtonBeingPressed(14,0) then
      mainMenu()
    end

    if IsButtonBeingPressed(1,0) and IsButtonBeingPressed(0,0) then
      ChapterSet(2)
